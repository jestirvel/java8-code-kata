...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map((c) -> c.getAge()).sorted((a, b) -> a - b);
    ...
    public void top3RichCustomer() {
         ...
         */
		Stream<String> top3RichCustomerStream = customerList.stream().sorted((a, b) -> b.getBudget() - a.getBudget())
				.map((c) -> c.getName()).limit(3);
